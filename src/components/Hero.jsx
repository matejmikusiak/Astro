...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-20">
      {/* Animated background orbs - using CSS animations instead of JS */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-accent-violet/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-accent-cyan/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 w-48 h-48 md:w-64 md:h-64 bg-accent-pink/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        {/* Description */}
        <p className="text-lg text-dark-500 mb-12 max-w-2xl mx-auto">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="w-6 h-10 rounded-full border-2 border-dark-600 flex items-start justify-center p-2">
          <div className="w-1.5 h-1.5 rounded-full bg-accent-violet animate-bounce" />
        </div>
      </div>
    </section>
  );
